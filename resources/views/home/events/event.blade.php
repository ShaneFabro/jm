                            ...
                            <div class="row">
                                ...
                                <div class="box alt">
                                    <div class="row gtr-50 gtr-uniform">
                                        ...
                                        <div class="col-xs-12">
                                            <a href="{{route('event_view', $latest->id)}}">
                                                <span class="image fit event latest"><img
                                                        src="{{$latest->photo ? $latest->photo->file : 'http://placehold.it/400x400'}}"
                                                        alt="" /></span>


                                                <span class="image fit event title">
                                                    {{$latest->created_at}}
                                                    <h3><strong>{{$latest->title}}</h3></strong></a></span>
                                        </div>
